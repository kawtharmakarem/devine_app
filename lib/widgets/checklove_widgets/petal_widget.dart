...
class Petal extends StatefulWidget {
  const Petal({super.key, required this.angle, required this.index});
  final double angle;
  final int index;
                      ...
                      content: Align(
                        child: Text(
                          ...
                          style: size.width < AppConstants.maxMobileWidth
                              ...
                              :size.width<AppConstants.maxTabletWidth? AppStyles.styleBold24(context).copyWith(
                                  fontSize: getResponsiveFontSizeText(context,
                                      fontSize: 32),
                                ):AppStyles.styleBold24(context).copyWith(fontSize: getResponsiveFontSizeText(context, fontSize: 40)),
                        ),
                      ),
                    ));
                  setState(() {});
