...
List<GridViewItemModel> items=[
  GridViewItemModel(image: AppImages.dailytarot,imageBg: AppImages.dailytarotBg, title: "Daily tarot",
   description: "Hold on tight. You're about to uncover some juicy intel about your destined partner!\nWant a hint? Let the wisdom of Tarot guide you, my friend.",
    ...
    detailsTitle: "Introspection, Solitude, and Seeking Knowledge"),
     ...
     GridViewItemModel(image: AppImages.weekendtarot,imageBg: AppImages.weekendtarotBg, title: "Weekend tarot fortune",
   description: "Shake off the week's stress with a soul-stirring Tarot reading this weekend.\nUnveil hidden possibilities and find clarity for the days ahead.",
    ...
    detailsTitle:"Spiritual Guidance and Illumination" ),
     ...
     GridViewItemModel(image: AppImages.weeklytarot,imageBg: AppImages.weeklytarotBg, title: "Weekly tarot fortune",
   description: "Explore the energies that will influence your week ahead.\nGain insights and guidance to navigate through the upcoming week.",
    ...
    detailsTitle: "Healing, Patience, and Finding Harmony"),
     ...
     GridViewItemModel(image: AppImages.whereistarot,imageBg: AppImages.whereistarotBg, title: "Where is my destined partner",
   description: "Explore the energies that will influence your week ahead.\nGain insights and guidance to navigate through the upcoming week.",
    likesNumber: 15, 
    seeNumber: 10,
    ...
    GridViewItemModel(image: AppImages.careertarot,imageBg: AppImages.careertarotBg, title: "Career",
   description: "Explore the energies that will influence your week ahead.\nGain insights and guidance to navigate through the upcoming week.",
    likesNumber: 15, 
    seeNumber: 10,
    ...
    detailsTitle:"Taking Risks and Embracing New Opportunities" ),
     ...
     GridViewItemModel(image: AppImages.financestarot,imageBg: AppImages.financestarotBg, title: "Finances",
   description: "Explore the energies that will influence your week ahead.\nGain insights and guidance to navigate through the upcoming week.",
    likesNumber: 15, 
    seeNumber: 10,
    ...
    detailsTitle: "Intuition, Secrets, and the Subconscious"),
     ...
     GridViewItemModel(image: AppImages.changetarot,imageBg: AppImages.changetarotBg, title: "How to change my luck?",
   description: "Explore the energies that will influence your week ahead.\nGain insights and guidance to navigate through the upcoming wee",
    ...
    GridViewItemModel(image: AppImages.hiddentarot,imageBg: AppImages.hiddentarotBg, title: "My hidden charm",
   description: "Explore the energies that will influence your week ahead.\nGain insights and guidance to navigate through the upcoming week.",
    likesNumber: 15, 
    seeNumber: 10,
    cardTitle: "The Wheel of Fortune",
    ...
    GridViewItemModel(image: AppImages.lifeclaritytarot,imageBg:AppImages.lifeclaritytarotBg , title: "Life clarity",
   description: "Explore the energies that will influence your week ahead.\nGain insights and guidance to navigate through the upcoming week.",
    likesNumber: 15, 
    seeNumber: 10,
    cardTitle:"The Hermit" ,
    ...
    GridViewItemModel(image: AppImages.lifelessons,imageBg: AppImages.lifelessonsBg, title: "Life lessons",
   description: "Explore the energies that will influence your week ahead.\nGain insights and guidance to navigate through the upcoming week.",
    likesNumber: 15, 
    seeNumber: 10,
    ...
    detailsTitle:"Abundance, Creativity, and Nurturing" ),
     ...
     GridViewItemModel(image: AppImages.feeltarot,imageBg: AppImages.feeltarotBg, title: "How do you feel about yourself",
   description: "Explore the energies that will influence your week ahead.\nGain insights and guidance to navigate through the upcoming week.",
    likesNumber: 15, 
    seeNumber: 10,
    cardTitle:"The Wheel of Fortune" ,
    ...
    detailsTitle:"Karma and the Law of Attraction" ),
     ...
     GridViewItemModel(image: AppImages.reservedtarot,imageBg: AppImages.reservedtarotBg, title: "Reversed tarot card",
   description: "Explore the energies that will influence your week ahead.\nGain insights and guidance to navigate through the upcoming week.",
    likesNumber: 15, 
    seeNumber: 10,
