...
class NotificationsPage extends StatelessWidget {
  ...
  showDivider: false,
  leading:const IconWidget(color: Colors.redAccent, icon: Icons.notification_add),
  child: SettingsScreen(
    title:"Notifications" ,
    hasAppBar: false,
  
    children: [
    const  CustomBackButton(title: 'Notifications',),
...
Widget  buildNews(BuildContext context,double width) =>SwitchSettingsTile(title: 'News For you', settingKey: keyNews,
subtitle: '',
  titleTextStyle: AppStyles.styleRegular20(context).copyWith(fontSize: getResponsiveFontSizeText(context, fontSize:width<AppConstants.maxMobileWidth? 20:28)),
showDivider: false,
...
onChange: (val){},);
 ...
 Widget buildActivity(BuildContext context,double width) => SwitchSettingsTile(title: 'Account Activity',
 ...
 Widget buildAppUpdates(BuildContext context,double width) =>SwitchSettingsTile(title: 'NewsLetter', settingKey: keyLetter,
 showDivider: false,
  titleTextStyle: AppStyles.styleRegular20(context).copyWith(fontSize: getResponsiveFontSizeText(context, fontSize:width<AppConstants.maxMobileWidth? 20:28)),

 leading:const IconWidget(color: Colors.redAccent, icon: Icons.text_snippet),);
  
Widget  buildNewsLetter(BuildContext context,double width) => SwitchSettingsTile(title: 'AppUpdates', settingKey: keyUpdates,
showDivider: false,
  titleTextStyle: AppStyles.styleRegular20(context).copyWith(fontSize: getResponsiveFontSizeText(context, fontSize:width<AppConstants.maxMobileWidth? 20:28)),

leading:const IconWidget(color: Colors.greenAccent, icon: Icons.update),);
}
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        }, icon:Icon(Icons.arrow_back,size:width<AppConstants.maxMobileWidth? 40:60,)),
        
        Text(title,style: AppStyles.styleBold24(context).copyWith(color: AppColors.darkPrimary),),
        const SizedBox()
      ],
    );
  }
