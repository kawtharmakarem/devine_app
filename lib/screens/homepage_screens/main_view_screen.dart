...
class _MainViewScreenState extends State<MainViewScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        bottomNavigationBar: width < AppConstants.maxTabletWidth
            ? MotionTabBar(
