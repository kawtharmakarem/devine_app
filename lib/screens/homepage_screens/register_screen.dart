...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        body:width<AppConstants.maxTabletWidth?  getMobileRegister(width, context, height):getDesktopAnimatioRegister(width, context, height),
      ),
    );
  }
  ...
  Widget getDesktopAnimatioRegister(double width, BuildContext context, double height) {
    return Stack(
          children: [
      Positioned(
          top: height*0.1,
