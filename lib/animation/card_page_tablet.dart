  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: width < TarotAppConstants.tabletMaxWidth
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
              ...
              Text(
                ...
                style: AppStyles.styleSemiBold24(context).copyWith(
                    fontSize: getResponsiveFontSizeTextTarot(context,
                        fontSize: width < TarotAppConstants.mobileMaxWidth
                            ? 32
                            : 50)),
              ),
              const SizedBox(),
          ...
          SizedBox(
            //width:width<AppConstants.mobileMaxWidth? 460:double.infinity,
            width: width,
                    ...
                    child: Text('Shuffle Cards',
                        style: width < TarotAppConstants.mobileMaxWidth
                            ...
                            : AppStyles.styleSemiBold24(context).copyWith(
                                fontSize: getResponsiveFontSizeTextTarot(
                                    context,
                                    fontSize: 40))),
                  ),
                ),
