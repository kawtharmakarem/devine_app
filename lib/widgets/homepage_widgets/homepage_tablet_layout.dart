...
class HomePageTabletLayout extends StatefulWidget {
  const HomePageTabletLayout({super.key});

  @override
  State<HomePageTabletLayout> createState() => _HomePageTabletLayoutState();
}
...
class AnimationScreen extends StatefulWidget {
  const AnimationScreen({required this.color, super.key});
...
class HolePainter extends CustomPainter {
  HolePainter(
      {required this.color, required this.holeSize, required this.opacity});
