...
class CustomMeditationContactUsDialog extends StatelessWidget {
  const CustomMeditationContactUsDialog({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Image.asset(AppImages.meditationLogo,fit: BoxFit.fill,)),
            Text(
              "Let's do Meditation to Manifest with Low of Attraction and Affirmations.\nBook personalised call Now!!",textAlign: TextAlign.center,
