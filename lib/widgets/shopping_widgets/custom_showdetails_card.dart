...
class CustomShowDetailsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        text0!=null?  CustomShoppingLine(text: text0!):const SizedBox(),
            const SizedBox(
              height: 10,
            ),
         text2!=null?   CustomShoppingLine(text: text2!):const SizedBox(),
            const SizedBox(
              height: 10,
            ),
           text3!=null? CustomShoppingLine(text: text3!):const SizedBox(),
