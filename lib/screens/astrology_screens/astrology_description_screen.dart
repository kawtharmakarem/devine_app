...
class _AstrologyDescriptionScreenState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:width<AppConstants.maxMobileWidth? getMobileDescription(width, context):width<AppConstants.maxTabletWidth? getTabletDescription(width, context):getDesktopDescription(width, context),
    );
  }
  ...
  Column getTabletDescription(double width, BuildContext context) {
    return Column(
      children: [
        ...
        Container(
            width: width*0.6,
            child: Image.asset(widget.astrologyModel.image,fit: BoxFit.fill,)),
        const SizedBox(
          height: 10,
        ),
        Text(
