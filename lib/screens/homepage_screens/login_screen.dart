...
import '../../widgets/homepage_widgets/animation_homepage_widget.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        body:width<AppConstants.maxTabletWidth? getMobileLogin(width, height, context):getDesktopAnimationLogin(width, height, context),
      ),
    );
  }
  ...
  // }
   ...
   Widget getDesktopAnimationLogin(double width, double height, BuildContext context) {
    return Stack(
      children: [
        Positioned(
              top: height*0.15,
